...
var buttonOpenMenu = document.querySelector('.nav__button');
...
var addMask = function addMask() {
  ...
  if (form) {
    var phoneInputs = form.querySelectorAll('input[name="tel"]');
...
var addValid = function addValid() {
  if (form) {
    var input = form.querySelectorAll('form input');
    var checkbox = form.querySelector('form input[name="agreement"]');
    var regExpEmail = /^(((?:(?![\t-\r "\(\),\.:-<>@\[\]\xA0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000\uFEFF])[\s\S])+(\.(?:(?![\t-\r "\(\),\.:-<>@\[\]\xA0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000\uFEFF])[\s\S])+)*)|("(?:[\0-\t\x0B\f\x0E-\u2027\u202A-\uD7FF\uE000-\uFFFF]|[\uD800-\uDBFF][\uDC00-\uDFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF])+"))@(((?:(?![\t-\r "\(\),\.:-<>@\[\]\xA0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000\uFEFF])[\s\S])+\.)+(?:(?![\t-\r "\(\),\.:-<>@\[\]\xA0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000\uFEFF])[\s\S]){2,})$/i;
    var isValidateEmail;
    var isValidateName;
    var isValidateTel;
    var valid;
    var validateElement = function validateElement(element) {
      ...
      if (element.name === 'agreement') {
        if (element.checked) {
          ...
          form.querySelector('.form__error-checkbox').textContent = 'Согласитесь с условиями';
        }
      }
    };
    input.forEach(function (element) {
      ['blur', 'input', 'focus'].forEach(function (elem) {
        element.addEventListener(elem, function () {
    ...
    form.addEventListener('submit', function (evt) {
      ...
      if (!checkbox.checked) {
        ...
        form.submit();
        form.querySelector('.form__message').textContent = 'Форма отправлена успешно';
      } else {
        evt.preventDefault();
        input.forEach(function (element) {
          validateElement(element);
...
var addScroll = function addScroll() {
  ...
  button.forEach(function (element) {
    element.addEventListener('click', function (evt) {
      ...
      var hash = id.replace('#', '');
      var buttonId = document.getElementById(hash);
      if (element.hash === id) {
        if (viewport <= 768) {
          headerNav.classList.remove('nav__menu-mobile');
